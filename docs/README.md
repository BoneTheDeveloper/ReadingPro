...
| [Architecture](Architecture/system-architecture.md) | How is it built? | [System architecture](Architecture/system-architecture.md): runtime, frontend UI, auth, database design, storage, observability, deployment. Frontend has a [screen architecture](Architecture/frontend-ui-architecture/README.md) + [component catalog](Architecture/frontend-ui-architecture/component-catalog.md). <!-- TODO: replace with real per-topic file links if these are separate docs --> |
