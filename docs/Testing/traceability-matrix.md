...
| US-09 | UC-08 | `GET /api/study/studio/artifacts` | TS-13 | `src/server/modules/study/passage/studio-artifacts-service.test.ts` |
| US-10 | UC-12 | `GET/POST /api/study/studio/chat` | TS-21 | `tests/vitest/integration/api/study-chat-route.test.ts` |
...
| US-16 | UC-10 | `PATCH/DELETE /api/vocabulary/sets/[id]` | TS-17 | `tests/vitest/integration/api/vocabulary-set-update-delete-routes.test.ts` |
...
| US-22 | UC-07 | `GET /api/progress/stats` | TS-12 | `tests/vitest/integration/components/progress/progress-dashboard.integration.test.tsx` |
