...
| Study chat | Study chat panel | Chat panel client state; study response schemas | `src/app/api/study/chat` | Chat service; AI model config | `study_chat_messages`, `passages`, `profiles` | API, component | [Study chat API](API/Routes/study/chat.md), [Study chat flow](Flows/study-chat-flow.md) |
| Studio artifacts | Study studio and quiz UI | Study API client; studio actions | `src/app/api/study/artifacts`, `src/app/api/study/questions` | Artifacts service; question generator | `studio_artifacts`, `questions`, `quiz_results`, `passages` | API, action, component | [Study artifacts API](API/Routes/study/artifacts.md), [Study questions API](API/Routes/study/questions.md) |
