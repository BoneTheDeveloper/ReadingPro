...
| Studio questions | Study quiz UI | Study API client; question generation action | `src/app/api/studio-questions` | Question generator; study response schemas | `questions`, `passages` | API, action | [Studio questions API](API/Routes/studio-questions-feature.md), [Study flow](Flows/study-flow.md) |
...
| Cards / review | Study quiz UI; progress dashboard | Study API client | `src/app/api/cards` | `quiz-review.ts`; `scheduler.ts` | `questions`, `question_reviews` | API, query, algorithm | [Cards API](API/Routes/cards-feature.md), [Spaced repetition flow](Flows/spaced-repetition-flow.md) |
| Progress / session | Progress page and dashboard | Progress dashboard client | `src/app/api/progress`, `src/app/api/study-session` | Progress/session queries | `study_sessions`, `quiz_attempts`, `question_reviews` | API, component, query | [Progress API](API/Routes/progress-feature.md), [Study session API](API/Routes/study-session-feature.md), [Progress UI](Architecture/frontend-ui-architecture/progress-page.md) |
