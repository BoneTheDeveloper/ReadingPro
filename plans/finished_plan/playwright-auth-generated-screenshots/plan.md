...
|-------|------|--------|-------|
| 1 | [Environment and auth setup](./phase-01-env-auth-setup.md) | Completed | Local env loading, clear auth errors, `.auth/user.json` creation |
| 2 | [Playwright project split and smoke tests](./phase-02-project-split-smoke.md) | Completed | Public/authenticated project separation and `/en/study` smoke coverage |
| 3 | [Screenshot auth flow and command interface](./phase-03-screenshot-flow.md) | Completed | Authenticated screenshots, generated output defaults, `PAGE=` Make interface |
| 4 | [Docker and generated-output hygiene](./phase-04-docker-generated-output.md) | Completed | Host-mounted generated screenshots and ignore rules |
| 5 | [CI integration and secret gates](./phase-05-ci-integration.md) | Completed | GitHub Actions E2E, Chromium install, missing-secret skip, DB readiness |
| 6 | [Verification and documentation cleanup](./phase-06-verification-docs.md) | Completed | Local verification commands and setup documentation |
