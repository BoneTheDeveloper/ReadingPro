...
## Success Criteria
- [x] `pnpm e2e:screenshot` creates `generated/screenshot/study-screenshot.png`.
- [x] `make screenshot PAGE=/en/study NAME=study` creates `generated/screenshot/study.png`.
- [x] Screenshot spec contains no duplicated sign-in form steps.
- [x] Screenshot flow fails clearly if auth redirects back to sign-in.
