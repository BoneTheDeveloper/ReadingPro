...
## Success Criteria
- [x] Docker screenshot output appears under host `generated/screenshot/`.
- [x] `git status --short` does not show generated screenshots.
- [x] Docker build context excludes generated screenshots and auth state.
