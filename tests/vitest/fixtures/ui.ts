...
import type { PassageData, QuestionData, StudioArtifact } from "@/features/study/model/types";
...
export function createStudyResult(overrides: Partial<StudioArtifact> = {}): StudioArtifact {
  return {
    id: "result-test-1",
    type: "quiz",
